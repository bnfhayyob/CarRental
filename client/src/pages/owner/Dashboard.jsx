...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Toṭal Bookings", value: data.totalBookings, icon: assets.listIconColored },
          ...
          {data.recentBookings.map((booking,index)=>(
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                <div className='hidden md:fmex items-center justify-center w-12 h-12 rounded-full bg-primary/10'>
