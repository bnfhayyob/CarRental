...
const Testimonial = () => {
  ...
  return (
    <div className="py-28 px-6 ms:px-16 lg:px-26 xl:px-44">

        <Title title="What Our Customers Say" subTitle="Discover why discerning travelers choose StayVenture for their luxury accommondations arround the world."/>
